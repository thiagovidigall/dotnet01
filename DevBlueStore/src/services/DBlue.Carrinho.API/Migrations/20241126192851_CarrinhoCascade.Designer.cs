...
namespace DBlue.Carrinho.API.Migrations
{
    ...
    [Migration("20241126192851_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBlue.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DBlue.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DBlue.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("DBlue.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("DBlue.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("DBlue.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
